...
def Qlearning(env, qepsilon=0.1,q_tol=.001, lr=0.8,decay=.999, qgamma=0.95, episodes=10000, initial=0,report=False):
    ...
    for episode in range(episodes):
        ...
        while True:
            ...
            if terminate:
                break 
        if np.allclose(Q_old, Q,atol=q_tol):
            if report:
